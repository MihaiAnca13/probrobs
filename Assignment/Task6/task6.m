...
save('data','data'); % vel cmds
save('estimate_data','estimate_data'); % vel model output
save('odom_data','odom_data'); % odometry data
save('data_features','data_features'); % range and bearing for each fiducial
%%
